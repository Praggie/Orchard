...
using System.Net.Mail;
    ...
    public class IMAPClientTaskHandler : IScheduledTaskHandler
    {
        ...
        private const int PeriodInMinutes = 30;
            ...
            IScheduledTaskManager taskManager)
        {
            ...
            try
            {
                DateTime firstDate = DateTime.UtcNow.AddSeconds(PeriodInMinutes);
        ...
        public void Process(ScheduledTaskContext context)
        {
            if (context.Task.TaskType == TaskType)
            {
                ...
                {
                    DateTime nextTaskDate = DateTime.UtcNow.AddSeconds(PeriodInMinutes);
