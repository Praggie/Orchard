...
namespace Orchard.CRM.Core
{
    ...
    public class Migrations : DataMigrationImpl
    {
        ...
        public Migrations(Lazy<ICRMSetup> crmSetup, IRepository<StatusRecord> statusRepository)
        {
        ...
        public int Create()
        {
            ...
            SchemaBuilder.CreateTable("EmailTemplateRecord", table => table
                          ...
                          .Column<string>("Name", c => c.WithLength(50).NotNull())
                          .Column<string>("Subject", c => c.WithLength(50).NotNull())
        ...
        public int UpdateFrom3()
        {
            ...
            solvedStatus.StatusTypeId = StatusRecord.SolvedStatus;
        ...
        private void CreateFileUploadRecordAndPart()
        {
            ContentDefinitionManager.AlterPartDefinition("FileUploadPart", part =>
                ...
                .WithSetting("FileUploadPartSettings.FileTypes", "zip,rar,jpg,jpeg,png,gif,doc,docx,xls,xlsx,ppt,pptx,pdf")
        ...
        private void CreateTicketAndCommentsAndRelatedData()
        {
            ...
            coreSchemaBuilder.AlterTable(
              ...
              table => table
                .CreateIndex("CRM_Index_Orchard_Framework_ContentItemVersionRecord_ContentItemRecord_id",
