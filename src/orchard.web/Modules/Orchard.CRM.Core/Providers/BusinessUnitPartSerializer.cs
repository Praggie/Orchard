...
{
    public class BusinessUnitPartSerializer : IContetnPartSerializer
    {
        public string ForContentPart
        {
            get { return "BusinessUnitPart"; }
        }
        ...
        public object GetSerializableObject(ContentPart contentPart)
        {
            ...
            BusinessUnitPart BusinessUnitPart = contentPart as BusinessUnitPart;

            return new
            {
                Id = BusinessUnitPart.Record.Id,
                Name = BusinessUnitPart.Record.Name,
                Description = BusinessUnitPart.Record.Description,
            };
        }
    }
}