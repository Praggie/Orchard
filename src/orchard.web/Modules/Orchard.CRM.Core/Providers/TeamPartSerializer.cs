...
{
    public class TeamPartSerializer : IContetnPartSerializer
    {
        public string ForContentPart { get { return "TeamPart"; } }
        ...
        public object GetSerializableObject(ContentPart contentPart)
        {
            ...
            TeamPart teamPart = contentPart as TeamPart;

            return new
            {
                Id = teamPart.Record.Id,
                Name = teamPart.Record.Name,
                Description = teamPart.Record.Description,
                BusinessUnitPartRecord = teamPart.Record.BusinessUnitPartRecord != null ?
                new
                {
                    Id = teamPart.Record.BusinessUnitPartRecord.Id,
                    Name = teamPart.Record.BusinessUnitPartRecord.Name
                } : null
            };
        }
    }
