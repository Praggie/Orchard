...
namespace Orchard.CRM.Core.Models
{
    ...
    public class TicketPartRecord : ContentPartRecord
    {
        ...
        /// <summary>
        /// Strange error happens, when there is no constructor and no Counter field, for some records, the Due date was null, despite it has a value in database, It
        /// seems it is related to the NHibernate
        /// </summary>
        public int Counter;
