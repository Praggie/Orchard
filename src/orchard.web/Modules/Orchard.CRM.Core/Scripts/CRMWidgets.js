...
(function () {
    ...
    crm.TicketsWidget = function (widget) {
        ...
        this.initialize = function () {
            ...
            itemsTable.find("tr")
                      .find("td:first input[type='checkbox']").click(checkBoxClickHandler);
            ...
            shareDialog
                ...
                .chosen({ width: "95%", max_selected_options: 3 });
        ...
        var deleteConfirmDialogYesButtonClickHandler = function (event) {
            ...
            var checkedCheckBoxes = $("#" + _self.options.itemsTableId)
                 .find("tr")
                 .find("td:first")
        ...
        var enableButtons = function () {
            ...
            buttons.removeClass("disable").addClass("active");
        ...
        var disableButtons = function () {
            ...
            var buttons = toolbar.find(".btn");
            buttons.removeClass("active").addClass("disable");
            for (var i = 0; i < buttons.length; i++) {
                var button = $(buttons[i]);
                var specificActiveClass = button.data("activeclass");
                var specificInActiveClass = button.data("inactiveclass");
        ...
        var checkAllClickHandler = function (event) {
            var checkBoxes = $("#" + _self.options.itemsTableId)
                .find("tr")
    ...
    crm.EditPermissionsWidget = function (widget) {
        ...
        this.initialize = function () {
            ...
            editOwnershipBar.find("input[name='AccessType']").click(accessTypeClickHandler);
        ...
        var accessTypeClickHandler = function () {
            var editOwnershipBar = $("." + _self.options.editOwnershipBar);
            var checkedAccessType = editOwnershipBar.find("input[name='AccessType']:checked");
    ...
    crm.FileListtWidget = function (widget) {
        ...
        this.initialize = function () {
            $("." + _self.options.fileListClass)
                .find("." + _self.options.deleteButtonClass)
        ...
        this.addNewFile = function (data) {
            if (data.success) {
                ...
                filesTag.find("." + _self.options.noFileUploadedClass).hide();
            }
        };
    ...
    crm.TicketsForContentItemsWidget = function (widget) {
        ...
        var flipFlopClickHandler = function (event) {
            ...
            if (flipFlop.data("state") == "active") {
                flipFlop
                    .data("state", "inactive")
                    .attr("title", flipFlop.data("inactivetitle"))
                ...
                flipFlop
                    .data("state", "active")
                    .attr("title", flipFlop.data("activetitle"))
