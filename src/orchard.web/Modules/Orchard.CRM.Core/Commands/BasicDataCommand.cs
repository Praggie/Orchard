    ...
    public class BasicDataCommand : DefaultOrchardCommandHandler
    {
        ...
        private void CreateStatusRecords()
        {
            ...
            var statusNames = new Tuple<int, string>[] {
                ...
                new Tuple<int,string>(StatusRecord.OpenStatus, "Open"), 
                new Tuple<int,string>(StatusRecord.SolvedStatus, "Solved"), 
                new Tuple<int,string>(StatusRecord.ClosedStatus, "Closed")};
...
<p>Orchard Collaboration System</p>",
        ...
        private void CreateTicketForReceivedEmailsWorkflow()
        {
            ...
            {
                State = "{ Title:\"{EEmail.Subject}\", Description:\"{EEmail.Body}\", DownloadEmailAttachments:\"true\" }",
            ...
            this.transitionRepository.Create(transitionRecord);
